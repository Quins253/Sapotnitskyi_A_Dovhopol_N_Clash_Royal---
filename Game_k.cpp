...
bool startGame(sf::RenderWindow& window, const std::string& username) {
    srand(static_cast<unsigned int>(time(nullptr)));

    std::vector<UnitStats> availableUnits = loadUnitStats("data/game/chary.txt");
